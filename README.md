...
- Расширенная типизация
   ...
   - (Необязательная) явная специализация типов при вызове неинициализирующих функций
...
| Объект            | Значения              | Класс             | Нет          | Нет          |
| Перечисление      | Случаи и перечисления | Протоколы         | Нет          | Да           |
