...
Объект А
      Родитель == Класс А
      Область видимости == Класс А
      Мембер Суб.А == 4                         Находится в объекте Б
      Мембер Суб.Б == 5                         Находится в объекте Б
      Мембер Суб.В == Функция 6                 Находится в объекте Б ещё до его инициализации
      Мембер Суб.Г == 7                         Находится в объекте Б
      Мембер А == 1                             Инициализирован классом А
      Мембер Б == Функция 2                     Инициализирован из класса А, область видимости при вызове == Объект А
      Мембер В == Функция 3 (виртуально)        Инициализирован из класса А, новейшая замена == Суб.В
...
Объект Б
      ...
      Мембер Супер.В == функция 3 (виртуально)  Находится в объекте А, новейшая замена == В
      Мембер А == 4                             Инициализирован классом Б
      Мембер Б == 5                             Инициализирован классом Б
      Мембер В == Функция 6                     Инициализирован из класса Б, область видимости при вызове == Объект Б
      Мембер Г == 7                             Инициализирован классом Б
```