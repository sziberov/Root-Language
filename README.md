...
- Расширенная типизация
   - По-настоящему опциональные типы
   - Явный композитный тип namespace
   - Объединённые типы
   - Разделение вложенных типов на статичные и объектные
   - Анонимные протоколы
   - Сравнение композитных типов по определению в случаях, когда по идентификатору - неоптимально
- Новые операторы и ключевые слова
   ...
   - `when`, как компактный аналог `switch`, который также можно использовать в объявлениях переменных
