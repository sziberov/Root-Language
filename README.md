...
Структура практически ничем не отличается от класса, за исключением того, что она являятся типом, также как и примитивы, передаваемым по значению (копируются объекты, чьи родители - структуры).
